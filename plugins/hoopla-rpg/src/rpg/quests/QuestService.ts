    ...
    return [
      ...
      },
      {
        ...
        questgiver: {
          ...
          questExplanation: '*Dragon eyes gleam with cold hunger* My <color="9B59B6">[Ice Box]</color>es... they contain fragments of my former power, scattered across this mountain when I was defeated long ago. I need exactly 4 of them to begin reclaiming what was stolen from me. Each box holds a piece of my draconic essence, frozen in time. With them, I can begin the ritual to restore my true form and power. The ice mountain itself was created by my defeat - a monument to my weakness. But no longer!',
          reminderMessage: '*Frost breath swirls around the dragon\'s maw* My <color="9B59B6">[Ice Box]</color>es still lie scattered across this frozen wasteland! I need all 4 of them to begin my ascension. The mountain trembles with my growing power, but without those artifacts, I remain trapped in this weakened state. Bring them to me, and I shall reward you beyond your wildest dreams!',
          completionMessage: '*The dragon\'s eyes blaze with cold fire* EXCELLENT! My <color="9B59B6">[Ice Box]</color>es! *massive claws clutch the artifacts* I can feel my power returning! But this is only the beginning... I need something more powerful still. The Nether holds artifacts of fire magic that, when combined with my ice essence, will make me unstoppable! The ritual requires an <color="9B59B6">[Ice Chest]</color> from that realm of flame and shadow.'
        }
      },
      {
        id: 'ice_king_2',
